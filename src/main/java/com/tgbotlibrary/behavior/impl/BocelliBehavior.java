...
@Component
public class BocelliBehavior extends BehaviorAbstract implements FileBehavior {
	...
	private final static String PATH_CONFIG = "bocelli.path";
	private static final String CONTAINS_STRING = "bocelli";
	...
	public void tryme(Message message) {
		...
		if (message.getText().toLowerCase().contains(CONTAINS_STRING)) {
			String _path = Config.getProperty(PATH_CONFIG,
					"/Users/mirko/Documents/workspace/telegram/TGBotLibrary/src/main/resources/photos/bocelli");
