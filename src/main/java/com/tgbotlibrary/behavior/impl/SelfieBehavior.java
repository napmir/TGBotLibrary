...
@Component
public class SelfieBehavior extends BehaviorAbstract implements FileBehavior {
	...
	private final static String PATH_CONFIG = "selfie.path";
	private static final String CONTAINS_STRING = "selfie";
